...
var fightOrSkip = function () {
    ...
    //conditinoal revursive function call
    if (promptFight === "" || promptFight === null) {
        window.alert("You need to provide a valid answer! Please try again.");
        return fightOrSkip();
    }

    // convert promptFight to all lowercase so we can with less options
...
var startGame = function() {
    ...
    for(var i = 0; i < enemyInfo.length; i++) {
        ...
        if(playerInfo.health > 0) {
            ...
            //pick new enemy from enemy.names array
            var pickedEnemyObj = enemyInfo[i];

            //reset enemy.health before new fight
            pickedEnemyObj.health = randomNumber(40, 60);

            //pass the pickedenemy.name varibale's value into the fight function, where it will assume the value of the enemy.name parameter
